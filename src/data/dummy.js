...
export const kpis = [
  {
    ...
    info: 'Composite score measuring how often IndusInd Bank appears in AI-generated answers across all tracked prompts and LLMs',
    iconBg: 'bg-blue-50',
  ...
  },
  {
    ...
    info: '% of citations that point to indusind.com properties — higher means you control the narrative',
  ...
  },
  {
    ...
    deltaDir: 'down',
    deltaTone: 'bad',
    sub: 'Top: reddit.com (25%)',
    info: '% of AI citations sourced from third-party sites you do not control — higher means the narrative is being shaped externally',
    iconBg: 'bg-violet-50',
